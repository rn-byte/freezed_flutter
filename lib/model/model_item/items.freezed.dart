...
abstract class $ItemsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String? category, String price});
}
...
class _$ItemsImpl implements _Items {
  _$ItemsImpl({required this.name, this.category, required this.price});
  ...
  @override
  String toString() {
    return 'Items(name: $name, category: $category, price: $price)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, category, price);
...
abstract class _Items implements Items {
  factory _Items(
      ...
      final String? category,
      required final String price}) = _$ItemsImpl;
